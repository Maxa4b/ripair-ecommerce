...
// MENU BURGER (legacy)
// ------------------
// Le layout e-commerce définit déjà `window.toggleMenu` + la logique de fermeture.
// On évite de l'écraser ici (sinon conflit: ouvertures/fermetures intempestives).
(function initLegacyBurgerFallback() {
  ...
  document.addEventListener('click', function (e) {
    ...
    if (menu.style.display === 'flex' && !menu.contains(e.target) && !button.contains(e.target)) {
